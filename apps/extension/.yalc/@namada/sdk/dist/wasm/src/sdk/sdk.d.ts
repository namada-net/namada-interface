...
export class Sdk {
  ...
  estimate_max_masp_tx_amount(msg: Uint8Array, chain_id: string): Promise<any>;
...
export interface InitOutput {
  ...
  readonly sdk_estimate_max_masp_tx_amount: (a: number, b: number, c: number, d: number, e: number) => any;
  ...
  readonly closure1236_externref_shim_multivalue_shim: (a: number, b: number, c: any) => [number, number];
  readonly closure2165_externref_shim: (a: number, b: number, c: any) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h034adba6fa3ac1ee: (a: number, b: number) => void;
  readonly closure2831_externref_shim: (a: number, b: number, c: any, d: any) => void;
