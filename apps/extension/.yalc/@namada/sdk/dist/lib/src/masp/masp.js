...
import { MaxMaspTxAmountMsgValue, Message, } from "../types";
/**
...
export class Masp {
     ...
     */
    getDescriptorMap(tx, shieldedHash) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.sdk.get_descriptor_map(tx, shieldedHash);
        });
    }
    /**
     ...
     */
    getNotesAndConversions(viewingKey, chainId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.sdk.query_notes_to_spend(viewingKey, chainId);
        });
    }
    estimateMaxMaspTxAmount(props, chainId) {
        return __awaiter(this, void 0, void 0, function* () {
            const msg = new Message();
            const encodedMsg = msg.encode(new MaxMaspTxAmountMsgValue(props));
            return yield this.sdk.estimate_max_masp_tx_amount(encodedMsg, chainId);
        });
    }
}
