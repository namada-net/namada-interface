...
__decorate([
    field({ type: "string" })
], MaspTxConv.prototype, "token", void 0);
__decorate([
    field({ type: "string" })
], MaspTxConv.prototype, "value", void 0);
export class CommitmentMsgValue {
    constructor(data) {
        ...
        const maspTxOut = data.maspTxOut
            ...
            : undefined;
        const maspTxConv = data.maspTxConv
            ? data.maspTxConv.map((txConv) => txConv.map((txConv) => new MaspTxConv(txConv)))
            : undefined;
...
__decorate([
    field({ type: option(vec(vec(MaspTxConv))) })
], CommitmentMsgValue.prototype, "maspTxConv", void 0);
